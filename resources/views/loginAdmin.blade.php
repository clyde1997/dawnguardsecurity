...
<head>
    ...
    <title>Dawnguard Security Agency - Admin Log In</title>
</head>
<body>
    ...
    <div class="container-md d-inline justify-content-center">
        ...
        <div class="form_container container-md">
                ...
                <!--Form for Admin-->
                <div class="form_body container-md" id="adminform">

                    <form method="POST" action="adminlogin" id="user_login_form" class="form">
                        @csrf
                        <div class="row pb-4">
        
                            <div class="col-md-12">
            
                                <label class="form-label text-white"><b>Admin User Name:</b></label>
                                <input type="text" class="form-control" name="adminname" id="adminname" placeholder="Enter Admin Username" required> 
                        ...
                        <div class="row pb-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <label class="form-label text-white"><b>Admin Password:</b></label>
                                <input type="password" class="form-control" name="adminpassword" id="adminpassword" placeholder="Enter Admin Password" required> 
