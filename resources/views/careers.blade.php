...
<head>
    ...
    <title>Dawnguard Security Agency - Careers</title>
</head>
<body>
    ...
    <div class="main_Cover">
      ...
      <img src="./images/careers/career_Cover.jpg" class="img-fluid">
    ...
    <div class="container-md pt-5 pb-5">
        ...
        @if(isset($careers) && count($careers) > 0)
            ...
            <div class="scroll-animations row" id="careerRow1">

                <label class="pb-3"><b>Position Title: </b><label id="positionTitle">{{ $career->positiontitle }}</label></label>

                <label class="pb-3"><b>Location: </b><label id="location">{{ $career->location }}</label></label>

                <label class="pb-3"> <b>Job Description:</b></label>
                <p class="pb-3" id="jobScope">{{ $career->jobdescription }}</p>

                <label class="pb-3"> <b>Qualifications:</b> </label>

                <ul>
                    
                        <li>{{ $career->qualifications1 }}</li>
                        <li>{{ $career->qualifications2 }}</li>
                        <li>{{ $career->qualifications3 }}</li>
                        <li>{{ $career->qualifications4 }}</li>
                        <li>{{ $career->qualifications5 }}</li>
                        <li>{{ $career->qualifications6 }}</li>
                        <li>{{ $career->qualifications7 }}</li>
                        <li>{{ $career->qualifications8 }}</li>
                  
                </ul>

                <div class="button_submit pb-5">

                    <button class="btn btn-dark" type="button" id="submitBtn" onclick="sendEmail()">Submit Resume</button>
        ...
        @else
            ...
            <p class="lead text-center">There Are No Career Openings For Now</p>
    ...
    <script src="{{ asset('javascript/submitresumeEmail.js') }}"></script>
